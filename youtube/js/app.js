const videos = {
  recomendados: [
    {
      id: 1,
      img:
        "https://cdn.reggaetonsinlimite.com/wp-content/uploads/2018/11/Ella-Quiere-Beber-Remix.jpg",
    ...
    },
    {
      id: 3,
      img:
        "https://cdn.reggaetonsinlimite.com/wp-content/uploads/2018/11/Creeme.jpg",
  ...
  principal: [
    ...
    },
    {
      id: 2,
      img:
        "https://images.genius.com/edbc5beb351bda262691f146453080a9.1000x1000x1.png",
      title: "Calma Remix 2",
      ...
      playlist: [
        {
          id: 1,
          img:
            "https://images.shazam.com/coverart/t313510678-b1257259293_s400.jpg",
          title: "No money - The aviary 2",
          autor: "Galantis ",
          views: " 72K vistas Hace 2 meses"
        },
...
function createHeader() {
  ...
  const header1 = document
    .getElementById("categoria1")
    .appendChild(item_header);
}
